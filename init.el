...
;; (set-face-foreground 'font-lock-warning-face "#00cd00")
;; (set-face-foreground 'font-lock-function-name-face "#00cd00")
...
;; (set-face-foreground 'font-lock-reference-face "#585858")
;;(custom-set-faces
;;     '(default ((t (:background "#7f7f7f" :family "liberation mono"))))
